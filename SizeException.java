/* 
 * Cette classe permet de verifier que les tailles entrees pour les differentes grilles 
...
public class SizeException extends Exception{
	...
	public SizeException(int e) {
		...
		case(1):
			System.err.println("Les tailles des differentes grilles doivent toutes deux etre paires ou impaires!");
			break;
			
		case(2):
			System.err.println("Les tailles des grilles doivent etre positives!");
			break;
